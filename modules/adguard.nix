  ...
  services.adguardhome = {
    ...
    settings = {
      ...
      filtering = {
        ...
        rewrites = [
          { domain = opts.dnsDomain; answer = opts.ipAddress; enabled = true; }
          { domain = opts.nextcloudDomain; answer = opts.ipAddress; enabled = true; }
        ];
